...
class BeauteCategoryPage extends StatefulWidget {
  const BeauteCategoryPage({super.key});

  @override
  State<BeauteCategoryPage> createState() => _BeauteCategoryPageState();
}

class _BeauteCategoryPageState extends State<BeauteCategoryPage> {
  final ProductService _productService = ProductService();

  bool _loading = true;
  List<Map<String, dynamic>> _allProducts = [];
  String _search = '';
  String _segment = 'Tous'; // Homme / Femme / Tous
  ...
  Future<void> _loadBeaute() async {
    setState(() => _loading = true);
    try {
      final list = await _productService.getProductsByCategory('Beauté');
      setState(() {
        _allProducts = list;
        _loading = false;
      });
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('Impossible de charger la catégorie Beauté: $e'),
              ...
              children: [
                ...
                TextField(
                  decoration: const InputDecoration(
                    ...
                    hintText: 'Rechercher un produit de beauté...',
                  ),
