...
class DivertissementCategoryPage extends StatefulWidget {
  const DivertissementCategoryPage({super.key});

  @override
  State<DivertissementCategoryPage> createState() => _DivertissementCategoryPageState();
}

class _DivertissementCategoryPageState extends State<DivertissementCategoryPage> {
  ...
  Future<void> _loadDivertissement() async {
    setState(() => _loading = true);
    try {
      final list = await _productService.getProductsByCategory('Divertissement');
      setState(() {
        _allProducts = list;
        _loading = false;
      });
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('Impossible de charger Divertissement: $e'),
              ...
              children: [
                ...
                TextField(
                  decoration: const InputDecoration(
                    ...
                    hintText: 'Rechercher un lieu ou un évènement...',
                  ),
