...
class ElectronicsCategoryPage extends StatefulWidget {
  ...
  @override
  State<ElectronicsCategoryPage> createState() => _ElectronicsCategoryPageState();
}
...
class _ElectronicsCategoryPageState extends State<ElectronicsCategoryPage> {
  ...
  Future<void> _loadElectronics() async {
    ...
    try {
      final list = await _productService.getProductsByCategory('Électroniques');
      setState(() {
        _allProducts = list;
        _loading = false;
      });
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('Impossible de charger la catégorie Électroniques: $e'),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Électroniques'),
        centerTitle: true,
      ),
      body: Column(
        children: [
              ...
              children: [
                ...
                TextField(
                  decoration: const InputDecoration(
                    ...
                    hintText: 'Rechercher un produit électronique...',
                  ),
